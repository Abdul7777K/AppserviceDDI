...
variable "create_app_service_plan" {
  description = "Set to true if you want to create a new App Service Plan; false to use an existing one"
  type        = bool
  default     = true
}
...
variable "sku_name" {
  description = "Provide the SKU to be used"
  type        = string
  default     = "S1"
...
variable "os_type" {
  description = "Provide the OS type to be used"
  type        = string
  default     = "Windows"
...
variable "per_site_scaling_enabled" {
  description = "Provide per_site_scaling_enabled"
  type        = bool
  default     = false
...
variable "log_analytics_workspace_name" {
  description = "The Name of the log_analytics_workspace for app insight"
  default     = null
}
variable "log_analytics_workspace_id" {
  description = "The Name of the existing log_analytics_workspace id  for app insight"
  default     = null
}
variable "log_analytics_sku" {
  description = "Provide log_analytics_workspace sku for app insight"
  default     = "PerGB2018"
}
